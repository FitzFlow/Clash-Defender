...
void drag_and_drop_canon_3(all_t *all)
{
    ...
    if (all->drag == 3 && all->elixir.nb_elixir >= 3) {
        ...
        drop_tower_canon_lv3(all, click_position);
...
void drag_and_drop_wizard_3(all_t *all)
{
    ...
    if (all->drag == 5 && all->elixir.nb_elixir >= 5) {
        ...
        drop_tower_wizard_lv3(all, click_position);
...
void drag_and_drop_tesla_3(all_t *all)
{
    ...
    if (all->drag == 7 && all->elixir.nb_elixir >= 8) {
        ...
        drop_tower_tesla_lv3(all, click_position);
...
void drag_and_drop_archery_3(all_t *all)
{
    ...
    if (all->drag == 1 && all->elixir.nb_elixir >= 4) {
        ...
        drop_tower_archery_lv_3(all, click_position);
